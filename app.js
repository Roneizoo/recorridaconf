...
function dominantType(types){var best='own',bestQty=-1;['own','boitel','partnership'].forEach(function(t){if((types[t]||0)>bestQty){bestQty=types[t]||0;best=t;}});return best;}
...
function renderPenMap(rows){
  ...
  el('penMap').innerHTML=blocksHtml||'<div class="empty">Nenhum curral corresponde aos filtros escolhidos.</div>';
}
